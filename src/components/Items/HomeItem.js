  ...
  return (
    <div className="flex-none py-6 px-3">
      <div className="flex flex-col sm:w-60 md:w-80 max-h-450 border-2 p-4 border-primary rounded-20 hover:shadow-xl transition-shadow duration-300 ease-in-out">
        ...
        <div className="max-h-195 md:max-h-275 border-2 rounded-20 border-second flex justify-center mt-2 cursor-pointer hover:bg-second hover:bg-opacity-25 transition-colors ease-linear">
          <img src={productImg} alt="" className="h-150 md:h-275 object-scale-down" />
        </div>
        <div className="flex mt-3 p-3">
          ...
          <div className="flex flex-col items-end">
            <h1 className="font-semibold md:text-xl">${newPrice}</h1>
