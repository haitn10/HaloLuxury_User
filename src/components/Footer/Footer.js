...
const Footer = () => {
  return (
    <footer className="relative bg-primary mt-150 pt-5 lg:pt-[60px] font-second">
        ...
        <div className="mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-light mb-7 text-base">
                Sed ut perspiciatis undmnis is iste natus error sit amet
                voluptatem totam rem aperiam.
              </p>
              <p className="text-light flex items-center text-sm font-medium">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-light mb-9 text-lg font-semibold">
                Resources
              </h4>
              <ul>
                <li>
                  <Link
                    to="#"
                    className="text-light mb-2 inline-block text-base leading-loose"
                  >
                    SaaS Development
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-light mb-9 text-lg font-semibold">Company</h4>
              <ul>
                <li>
                  <Link
                    to="#"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <Link
                  to="#"
                  className="text-light hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
              ...
              <p className="text-light text-base">&copy; 2023 Halo Luxury</p>
            </div>
          </div>
        </div>
      </div>
